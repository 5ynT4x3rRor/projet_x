...
// Vraie définition des variables globales gérées ici
std::string target = "";
...
void handle_commands() {
    ...
    while (true) {
        ...
        if (command == "exit" || command == "quit") {
            ...
            std::string candidate = command.substr(11); // "set target " fait 11 caractères
            ...
            std::string range_str = command.substr(10); // "set range " fait 10 caractères
